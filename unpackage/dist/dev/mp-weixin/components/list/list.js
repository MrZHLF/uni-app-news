...
/* harmony import */ var _list_vue_vue_type_template_id_48015944___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=48015944& */ 53);
...
/* harmony import */ var _list_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list.vue?vue&type=style&index=0&lang=scss& */ 57);
    ...
    getList: function getList(current) {var _this = this;
      ...
      this.$api.get_list({ name: this.tab[current].name, page: this.load[current].page, pageSize: this.pageSize }).then(function (res) {
        ...
        if (data.length === 0) {
          ...
          oldLoad.page = _this.load[current].page; //当数据没有了的时候，设置为0
